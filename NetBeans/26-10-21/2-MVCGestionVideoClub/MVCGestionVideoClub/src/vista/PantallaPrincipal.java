...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        itmEmpleado.setText("Gestionar Empleado");
        itmEmpleado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itmEmpleadoActionPerformed(evt);
            }
        });
        mnuGestion.add(itmEmpleado);

        itmPelicula.setText("Gestionar Pelicula");
        itmPelicula.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itmPeliculaActionPerformed(evt);
            }
        });
        mnuGestion.add(itmPelicula);

        itmAlquiler.setText("Gestionar Alquiler");
        itmAlquiler.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itmAlquilerActionPerformed(evt);
            }
        });
